        ...
        <div className="font-sans text-gray-900 bg-white">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                                Send personalized broadcasts, product updates, and newsletters directly to WhatsApp.
                                Achieve 98% open rates and drive real engagement.
                            </p>
                    ...
                    >
                        <div className="relative rounded-[2rem] bg-gray-900 p-2 shadow-2xl ring-1 ring-gray-900/10 max-w-6xl mx-auto">
                            ...
                            >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Campaign Sent</div>
                                    <div className="text-xs text-gray-500">10k Recipients</div>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">98% Open Rate</div>
                                    <div className="text-xs text-gray-500">Record Engagement</div>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
            ...
            <section className="py-20 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-10">Perfect for every update</p>
                    <div className="flex flex-wrap justify-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Mock Tags */}
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><MessageSquare /> Product Launches</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Check /> Monthly Newsletters</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Zap /> Flash Sales</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Users /> Event Invites</div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="Campaign Manager" />
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Create beautiful, rich-media broadcasts with images, videos, and interactive buttons. Schedule them for the perfect time.
                            </p>

                            <ul className="space-y-4 pt-4">
                                {['Advanced Segmentation', 'Rich Media Support', 'A/B Testing'].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-8 order-2 lg:order-1">
                            ...
                            <p className="text-lg text-indigo-200 leading-relaxed">
                                Get detailed insights into delivery rates, open rates, and click-through rates. Understand what your audience loves.
                            </p>

                            <div className="grid grid-cols-2 gap-6 pt-6">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <div className="text-3xl font-bold mb-1">98%</div>
                                    <div className="text-sm text-indigo-300">Open Rate</div>
                                </div>
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <div className="text-3xl font-bold mb-1">45%</div>
                                    <div className="text-sm text-indigo-300">Click Rate</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative order-1 lg:order-2">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-white/10 bg-gray-900" alt="Analytics" />
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="Personalization" />
                            ...
                            <div className="absolute -right-8 top-12 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center gap-3 animate-bounce-slow">
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Hello, Sarah!</div>
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Don't just spam. Send relevant messages based on customer tags, past purchases, and behavior. Treat 10,000 customers like 1.
                            </p>

                            <button className="text-indigo-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
                                See Personalization <ArrowRight className="w-5 h-5" />
                            </button>
                        </div>
                    ...
                    <div className="bg-[#4338ca] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <p className="text-indigo-200 text-xl mb-10">
                                Join brands driving 10x more engagement with Maskchat Newsletters.
                            </p>
