        ...
        <div className="font-sans text-gray-900 bg-white">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                                Provide instant 24/7 support across WhatsApp, Webchat, and Social Media.
                                Resolve 80% of queries automatically with a human-like touch.
                            </p>
                    ...
                    >
                        <div className="relative rounded-[2rem] bg-gray-900 p-2 shadow-2xl ring-1 ring-gray-900/10 max-w-6xl mx-auto">
                            ...
                            >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Query Resolved</div>
                                    <div className="text-xs text-gray-500">in 2 seconds</div>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
            ...
            <section className="py-20 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-10">Deploy instantly on</p>
                    <div className="flex flex-wrap justify-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Mock Logos */}
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><MessageSquare /> WhatsApp</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Smartphone /> Website</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Share2 /> Instagram</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Inbox /> Messenger</div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="No Code Builder" />
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-bold text-[#1e1b4b] leading-tight">
                                Build flows in minutes. Not months.
                            </h2>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Use our visual drag-and-drop builder to create complex conversation flows. No coding required. Just design, test, and launch.
                            </p>

                            <ul className="space-y-4 pt-4">
                                {['Visual Flow Builder', 'Pre-built Templates', 'Multi-language Support'].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-8 order-2 lg:order-1">
                            ...
                            <p className="text-lg text-indigo-200 leading-relaxed">
                                Never leave a customer waiting. Your AI Chatbot handles FAQs, bookings, and qualification 24/7, ensuring you capture every lead.
                            </p>

                            <div className="grid grid-cols-2 gap-6 pt-6">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <div className="text-3xl font-bold mb-1">0s</div>
                                    <div className="text-sm text-indigo-300">Wait Time</div>
                                </div>
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                        ...
                        <div className="relative order-1 lg:order-2">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-white/10 bg-gray-900" alt="24/7 Support" />
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="Smart Handover" />
                            ...
                            <div className="absolute -right-8 top-12 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center gap-3 animate-bounce-slow">
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Routing to Agent</div>
                                    <div className="text-xs text-gray-500">Complex Query Detected</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-bold text-[#1e1b4b] leading-tight">
                                Smart Human Handovers.
                            </h2>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                The AI handles the routine, but knows when to step back. Complex queries are instantly routed to the right human agent with full context.
                            </p>

                            <button className="text-indigo-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
                                See Handover in Action <ArrowRight className="w-5 h-5" />
                            </button>
                        </div>
                    ...
                    <div className="bg-[#4338ca] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <p className="text-indigo-200 text-xl mb-10">
                                Join businesses saving 1000s of hours with Maskchat AI Chatbots.
                            </p>
