        ...
        <div className="font-sans text-gray-900 bg-white">
                        ...
                        <div className="relative rounded-[2rem] bg-gray-900 p-2 shadow-2xl ring-1 ring-gray-900/10 max-w-6xl mx-auto">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">via WhatsApp Catalog</div>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
            ...
            <section className="py-20 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-10">Integrates with your commerce stack</p>
                    <div className="flex flex-wrap justify-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Mock Logos */}
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Share2 /> Shopify</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Inbox /> WooCommerce</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Zap /> Magento</div>
                        <div className="flex items-center gap-2 text-xl font-bold text-slate-500"><Users /> Salesforce</div>
                    </div>
                </div>
            </section>

            {/* FEATURE 1: Showcase Products */}
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="Showcase Products" />
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Showcase your products directly in WhatsApp. Let customers browse catalogs, add to cart, and checkout without ever leaving the app.
                            </p>

                            <ul className="space-y-4 pt-4">
                                {['Sync products from Shopify/WooCommerce', 'Automated catalog updates', 'Seamless checkout experience'].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-8 order-2 lg:order-1">
                            ...
                            <p className="text-lg text-indigo-200 leading-relaxed">
                                Recover abandoned carts, send automated order updates, and personalized product recommendations to boost your revenue.
                            </p>

                            <div className="grid grid-cols-2 gap-6 pt-6">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <div className="text-3xl font-bold mb-1">3x</div>
                                    <div className="text-sm text-indigo-300">Higher Conversion</div>
                                </div>
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <div className="text-3xl font-bold mb-1">70%</div>
                                    <div className="text-sm text-indigo-300">Open Rates</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative order-1 lg:order-2">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-white/10 bg-gray-900" alt="Sales Automation" />
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            <img src={MOCK_DASHBOARD} className="relative rounded-[2.5rem] shadow-2xl z-10 border border-gray-100" alt="Instant Support" />
                            ...
                            <div className="absolute -right-8 top-12 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center gap-3 animate-bounce-slow">
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Order Enquiry</div>
                                    <div className="text-xs text-gray-500">Resolved Automatically</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-bold text-[#1e1b4b] leading-tight">
                                Instant Support for Shoppers.
                            </h2>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Answer product questions, check order status, and handle returns instantly with AI-powered chatbots, keeping your customers happy.
                            </p>

                            <button className="text-indigo-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
                                See Storefront in Action <ArrowRight className="w-5 h-5" />
                            </button>
                        </div>
                    ...
                    <div className="bg-[#4338ca] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <p className="text-indigo-200 text-xl mb-10">
                                Join brands boosting their revenue with Maskchat Whatsapp Storefront.
                            </p>
...
export default WhatsappStorefront;
